...
\title{Classifying time series data using manifold techniques} % Poster title
...
\begin{block}{Experiments}
    ...
    % \begin{figure}
    %     \includegraphics[width=1\linewidth]{images/irvine.png}
    %     \caption{Sample data from SUNY EEG dataset}
    % \end{figure}
